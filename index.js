import{a as E,i as m,S as N}from"./assets/vendor-DZInknBW.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function r(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerPolicy&&(a.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?a.credentials="include":t.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(t){if(t.ep)return;t.ep=!0;const a=r(t);fetch(t.href,a)}})();const H="data:image/jpeg;base64,",I=document.querySelector(".artists-loader"),k=document.querySelector(".js-load-more");function V(A){const e=A.map(({strArtist:s,strBiographyEN:t,strArtistThumb:a,_id:c,genres:f})=>{const p=f.flatMap(g=>g.split("/")).map(g=>g.trim()),h=[...new Set(p)].map(g=>`<span class="artists-genre">${g}</span>`).join("");return`
    ...
    `}).join("");document.querySelector(".artists-list").insertAdjacentHTML("beforeend",e)}function q(){I.classList.remove("hidden")}function Q(){I.classList.add("hidden")}function K(){k.classList.remove("hidden")}function P(){k.classList.add("hidden")}function _(A,e){window.scrollBy({top:e,left:A,behavior:"smooth"})}const G=8;let M=1;function R(){return M}function X(A){M=A}async function Z(A="artists",e={limit:G,page:M}){const s=`https://sound-wave.b.goit.study/api/${A}`;try{return(await E.get(s,{params:e})).data}catch(t){throw m.warning({message:`Request error: ${t.message}`,position:"center"}),t}}let D=0,B,x=0;async function U(){try{q();const A=await Z();D=A.totalArtists,A.artists.length===0&&m.warning({message:"Sorry, but no artists were found",position:"center"}),V(A.artists),B=document.querySelector(".artists-item"),x=B.getBoundingClientRect().height;const e=R();let r=Math.ceil(D/e);if(e===r){P();return}K()}catch{m.warning({message:"Sorry, but no artists were found",position:"center"})}finally{Q()}}U();k.addEventListener("click",async()=>{P();const A=R();X(A+1),q(),await U(),Q(),_(0,x)});document.addEventListener("DOMContentLoaded",()=>{const A=document.querySelector(".feedback-section");if(!A)return;const e=A.querySelector(".splide.feedback-slider-splide"),r=A.querySelector(".splide__list.feedback-list-splide"),s=A.querySelector(".splide__arrows"),t=A.querySelector(".splide__pagination.feedback-splide-pagination"),a=A.querySelector(".loader-backdrop");if(!e||!r)return;const c="https://sound-wave.b.goit.study/api/feedbacks",f=15;let p=null;function L(){a&&a.classList.remove("is-hidden")}function h(){a&&a.classList.add("is-hidden")}function g(o,l="error"){l==="error"?m.error({title:"Error",message:o,position:"topRight"}):l==="success"?m.success({title:"Success",message:o,position:"topRight"}):l==="warning"?m.warning({title:"Warning",message:o,position:"topRight"}):m.info({title:"Info",message:o,position:"topRight"})}function y(o,l=""){const n=[e];s&&n.push(s),t&&n.push(t);const d=A.querySelector(".custom-feedback-message");if(d&&d.remove(),o==="error"||o==="no-feedback"){n.forEach(u=>{u&&(u.style.display="none")});const i=A.querySelector(".feedback-container");if(i){const u=document.createElement("p");u.className="custom-feedback-message",u.style.textAlign="center",u.style.padding="20px",o==="error"?(u.style.color="red",u.textContent=l||"Error loading feedbacks."):u.textContent=l||"There are no feedbacks yet.",e&&e.parentNode===i?e.insertAdjacentElement("afterend",u):i&&i.appendChild(u)}}else n.forEach(i=>{i&&(i.style.display="")});r&&o==="clear"&&(r.innerHTML="")}function S(o){const n=parseFloat(o);if(isNaN(n)){let b="";const J='<svg class="feedback-card__star" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M22 9.24l-7.19-.62L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27 18.18 21l-1.63-7.03L22 9.24zM12 15.4l-3.76 2.27 1-4.28-3.32-2.88 4.38-.38L12 6.1l1.71 4.04 4.38.38-3.32 2.88 1 4.28L12 15.4z"/></svg>';for(let C=0;C<5;C++)b+=J;return b}const d=Math.floor(n);let i="";const u=`<svg class="feedback-card__star feedback-card__star--filled" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
...
<path d="M9.07082 1.31791C9.41456 0.501451 10.5853 0.501452 10.9291 1.31791L12.9578 6.1368C13.1028 6.481 13.4305 6.71618 13.8066 6.74597L19.0726 7.16304C19.9648 7.23371 20.3266 8.3337 19.6468 8.90897L15.6347 12.3042C15.3482 12.5468 15.2229 12.9273 15.3105 13.2899L16.5363 18.3666C16.7439 19.2267 15.7968 19.9066 15.0329 19.4457L10.5245 16.7251C10.2024 16.5308 9.79744 16.5308 9.47542 16.7251L4.96693 19.4457C4.20305 19.9066 3.25589 19.2267 3.46357 18.3666L4.68936 13.2899C4.77692 12.9273 4.65176 12.5468 4.36519 12.3042L0.353001 8.90897C-0.326779 8.3337 0.0350068 7.23371 0.92723 7.16304L6.19329 6.74597C6.56944 6.71618 6.89709 6.481 7.04201 6.1368L9.07082 1.31791Z" fill="white"/>
        ...
        `}function O(o){if(p){try{p.destroy()}catch{}p=null}if(e&&o!==0){e.querySelector('[data-glide-el="controls[nav]"]')||e.querySelector(".splide__pagination");try{p=new N(e,{type:"slide",perPage:1,arrows:!!s,pagination:!!t,drag:!0,keyboard:"global"}),p.on("mounted",()=>{}),p.on("move",(l,n,d)=>{}),p.mount(),window.myTestSplide=p}catch{}}}async function W(){var o,l;L(),y("clear");try{const n=await E.get(c);if(!n.data||typeof n.data!="object"||!Array.isArray(n.data.data))throw new Error("Incorrect data type from server.");let d=n.data.data;if(d.length===0){y("no-feedback","There is no feedbacks yet."),h();return}y("success");const i=d.slice(0,f);if(r)r.innerHTML=i.map(Y).join("");else throw new Error("Show error: there is no .splide__list.");O(i.length)}catch(n){const d=((l=(o=n.response)==null?void 0:o.data)==null?void 0:l.message)||n.message||"Unknown error.";y("error",`Error: ${d}`),g(`Failed to fetch or display feedbacks: ${d}`,"error")}finally{h()}}e&&r?W():a&&h()});const w=document.querySelector(".mobile-menu"),z=document.querySelector(".js-mobile-menu"),AA=document.querySelector(".js-mobile-close-menu");z.onclick=()=>w.classList.add("is-open");AA.onclick=()=>w.classList.remove("is-open");document.addEventListener("keydown",A=>{A.key==="Escape"&&w.classList.remove("is-open")});w.querySelectorAll('a[href^="#"]').forEach(A=>{A.onclick=()=>w.classList.remove("is-open")});const eA=document.querySelector(".art-modal");function tA(A,e){const{intDiedYear:r,intFormedYear:s,intMembers:t,strArtist:a,strArtistThumb:c,strBiographyEN:f,strCountry:p,strGender:L,tracksList:h}=A,g=e.map(S=>`<div class="art-modal-gener"><p>${S}</p></div>`).join(""),y=`
              ...
              <div class="art-modal-wrapper-item">
                <div class="art-modal-titles">
                  ...
                  <p class="art-modal-biography">
                    Biography <br />
                    <span>${f||"We don't have this information"}</span>
                  </p>
                </div>
          ...
          </div>`}).join("")}function aA(A){const e=Math.floor(A/1e3),r=Math.floor(e/60),s=e%60;return`${r}:${s.toString().padStart(2,"0")}`}function oA(A){const e={};return A.forEach(r=>{const s=r.strAlbum;e[s]||(e[s]=[]),e[s].push(r)}),e}async function nA(A){const r=`https://sound-wave.b.goit.study/api/artists/${A}`;try{return(await E.get(r)).data}catch(s){throw m.warning({message:`Request error: ${s.message}`,position:"center"}),s}}const iA=document.querySelector(".art-modal"),v=document.querySelector(".backdrop"),j=document.querySelector(".modal-loader");document.addEventListener("DOMContentLoaded",()=>{const A=document.querySelector(".artists-list");A&&A.addEventListener("click",e=>{e.target.closest(".artists-learn-more-btn")&&cA(e)})});async function cA(A){A.preventDefault();const r=A.target.closest(".artists-learn-more-btn").closest(".artists-item"),s=r.querySelector(".artists-img"),t=s==null?void 0:s.dataset.id;if(t)try{const a=Array.from(r.querySelectorAll(".artists-box-genres .artists-genre")).map(f=>f.textContent);dA();const c=await nA(t);if(uA(),!c||!c.strArtist){m.warning({message:"Sorry, but no artist was found",position:"center"});return}iA.innerHTML="",tA(c,a),lA()}catch{m.error({message:"Failed to load artist data",position:"center"})}}function lA(){const A=document.querySelector(".art-modal");A&&(A.scrollTop=0),v.classList.add("is-visible"),document.body.style.overflow="hidden",window.addEventListener("keydown",F)}function T(){v.classList.remove("is-visible"),document.body.style.overflow="",window.removeEventListener("keydown",F)}function F(A){A.key==="Escape"&&T()}v.addEventListener("click",A=>{(A.target===v||A.target.closest(".modal-close-btn"))&&T()});function dA(){j.hidden=!1}function uA(){j.hidden=!0}
